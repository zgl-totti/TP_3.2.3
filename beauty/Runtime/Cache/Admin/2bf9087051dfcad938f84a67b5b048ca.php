...
<script language="JavaScript" src="/totti/Public/Admin/js/jquery.js"></script>
...
<body style="background:#f0f9fd;">
    ...
    <!--<dl class="leftmenu">
        ...
        <dd>
            <div class="title">
                <span><img src="/totti/Public/Admin/images/leftico01.png" /></span>
                <a href="<?php echo U('Index/main');?>" target="rightFrame">后台首页</a>
            </div>
        </dd>
        <dd>
            <div class="title">
                <span><img src="/totti/Public/Admin/images/leftico01.png" /></span>系统管理
            </div>
            <ul class="menuson">
        ...
        <dd>
            <div class="title">
                <span><img src="/totti/Public/Admin/images/leftico01.png" /></span>权限管理
            </div>
            <ul class="menuson">
                <li>
                    <div class="header">
        ...
        <dd>
            <div class="title">
                <span><img src="/totti/Public/Admin/images/leftico01.png" /></span>品牌管理
            </div>
        	<ul class="menuson">
                <li class="active">
                    <div class="header">
        ...
        <dd>
            <div class="title">
                <span><img src="/totti/Public/Admin/images/leftico01.png" /></span>分类管理
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
        ...
        <dd>
            <div class="title">
                <span><img src="/totti/Public/Admin/images/leftico01.png" /></span>商品管理
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
        ...
        <dd>
            <div class="title">
                <span><img src="/totti/Public/Admin/images/leftico01.png" /></span>会员管理
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
        ...
        <dd>
            <div class="title">
                <span><img src="/totti/Public/Admin/images/leftico01.png" /></span>订单管理
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
        ...
        <dd>
            <div class="title">
                <span><img src="/totti/Public/Admin/images/leftico01.png" /></span>广告管理
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
        ...
        <dd>
            <div class="title">
                <span><img src="/totti/Public/Admin/images/leftico01.png" /></span>活动发布
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
        ...
        <dd>
            <div class="title">
                <span><img src="/totti/Public/Admin/images/leftico01.png" /></span>评论管理
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
        ...
        <dd>
            <div class="title">
                <span><img src="/totti/Public/Admin/images/leftico01.png" /></span>反馈管理
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
        ...
        <dd>
            <div class="title">
                <span><img src="/totti/Public/Admin/images/leftico01.png" /></span>金币商城
            </div>
            <ul class="menuson">
                <li class="active">
                    <div class="header">
