...
<div class="mainindex">
    ...
    <?php if(is_array($userInfo)): $i = 0; $__LIST__ = $userInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><div class="welinfo">
            <span><img src="/totti/Public/Admin/images/sun.png" alt="天气" /></span>
            <b><?php echo ($val["username"]); ?>  早上好，欢迎使用后台管理系统</b>
        </div>

        <div class="welinfo">
            <span><img src="/totti/Public/Admin/images/time.png" alt="时间" /></span>
            <i>您上次登录的时间：<?php echo date('Y-m-d H:i:s',$val['lastlogin']);?></i> <i>您上次登录IP：<?php echo ($val["lastip"]); ?></i> 如非本人操作，请及时更改密码
        </div><?php endforeach; endif; else: echo "" ;endif; ?>

    <!--<ul class="iconlist">
    <li><img src="/totti/Public/Admin/images/ico01.png" /><p><a href="#">管理设置</a></p></li>
    <li><img src="/totti/Public/Admin/images/ico02.png" /><p><a href="#">发布文章</a></p></li>
    <li><img src="/totti/Public/Admin/images/ico03.png" /><p><a href="#">数据统计</a></p></li>
    <li><img src="/totti/Public/Admin/images/ico04.png" /><p><a href="#">文件上传</a></p></li>
    <li><img src="/totti/Public/Admin/images/ico05.png" /><p><a href="#">目录管理</a></p></li>
    <li><img src="/totti/Public/Admin/images/ico06.png" /><p><a href="#">查询</a></p></li>
    </ul>
    ...
    <div class="welinfo">
        <span><img src="/totti/Public/Admin/images/dp.png" alt="提醒" /></span>
        <b>服务器信息</b>
    </div>
    ...
    <div class="box"></div>
    <div class="welinfo">
        <span><img src="/totti/Public/Admin/images/icon10.png" alt="提醒" /></span>
        <b>商品销售信息</b>
    </div>
    ...
    <div class="welinfo">
        <span><img src="/totti/Public/Admin/images/ico03.png" alt="提醒" /></span>
        <b>商品销量信息</b>
    </div>
    ...
    <div class="box"></div>
    <div class="welinfo">
        <span><img src="/totti/Public/Admin/images/dingdan.png" alt="提醒" /></span>
        <b>商品库存量信息</b>
    </div>
    <table class="tablelist">
        <thead>
...
<script type="text/javascript" src="/totti/Public/Admin/js/echarts.min.js"></script>
<script type="text/javascript">
